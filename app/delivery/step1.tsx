      ...
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={tw`p-5 pb-10`}>
        ...
        <View style={tw`gap-4 mb-6`}>
          ...
          <View style={tw`flex-row items-center justify-between`}>
            <View style={tw`flex-row items-center gap-3`}>
              ...
              <Text style={tw`text-sm font-extrabold text-blue-600`}>Arrived at Pickup</Text>
            </View>
            <Text style={tw`text-xs font-semibold text-blue-600`}>10:28 AM</Text>
          </View>
          ...
          <View style={tw`flex-row items-center justify-between`}>
            <View style={tw`flex-row items-center gap-3`}>
              ...
              <Text style={tw`text-sm font-semibold text-slate-300`}>Picked Up</Text>
            </View>
          ...
          <View style={tw`flex-row items-center justify-between`}>
            <View style={tw`flex-row items-center gap-3`}>
              <View style={tw`w-6 h-6 rounded-full border-2 border-slate-300 bg-white`} />
              <Text style={tw`text-sm font-semibold text-slate-300`}>On the Way</Text>
            </View>
            <Text style={tw`text-xs font-medium text-slate-300`}>--:-- AM</Text>
          </View>
        ...
        <View style={tw`bg-blue-50/70 rounded-2xl p-3.5 flex-row items-center justify-center gap-2 mb-6 border border-blue-100`}>
          ...
          <View style={tw`items-center`}>
            ...
            <Text style={tw`text-[9px] text-slate-400 mt-0.5`}>Last updated: 10:28 AM</Text>
          </View>
        </View>
        ...
        <TouchableOpacity
          ...
          <Text style={tw`text-white font-extrabold text-base`}>I've Arrived at Pickup</Text>
        </TouchableOpacity>
