...
export default function DeliveryStep4Screen() {
      ...
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={tw`p-5 pb-10`}>
        ...
        <View style={tw`gap-4 mb-6`}>
          ...
          <View style={tw`flex-row items-center justify-between`}>
            <View style={tw`flex-row items-center gap-3`}>
              ...
              <Text style={tw`text-sm font-bold text-slate-900`}>On the Way</Text>
            </View>
            <Text style={tw`text-xs font-semibold text-slate-400`}>10:33 AM</Text>
          </View>

          {/* Step: Delivered (Active) */}
          <View style={tw`flex-row items-center justify-between`}>
            <View style={tw`flex-row items-center gap-3`}>
              ...
              <Text style={tw`text-sm font-extrabold text-blue-600`}>Delivered</Text>
            </View>
            <Text style={tw`text-xs font-extrabold text-blue-600`}>10:40 AM</Text>
          </View>
        </View>
        ...
        <View style={tw`bg-blue-50/70 rounded-2xl p-3.5 flex-row items-center justify-center gap-2 mb-6 border border-blue-100`}>
          ...
          <View style={tw`items-center`}>
            ...
            <Text style={tw`text-[9px] text-slate-400 mt-0.5`}>Last updated: 10:40 AM</Text>
          </View>
        </View>
        ...
        <TouchableOpacity
          ...
          <Text style={tw`text-white font-extrabold text-base`}>Mark as Delivered</Text>
        </TouchableOpacity>
