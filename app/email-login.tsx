      ...
      <KeyboardAvoidingView
        ...
        <View style={tw`flex-1 bg-white rounded-t-[36px] px-6 pt-6 shadow-2xl`}>
          <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={tw`pb-10`}>
            ...
            <Text style={tw`text-2xl font-black text-[#0B1044]`}>Email Login ✉️</Text>
            ...
            <View style={tw`flex-row bg-slate-100 p-1 rounded-2xl mb-5`}>
              <TouchableOpacity
                ...
                style={tw`flex-1 py-2.5 rounded-xl items-center justify-center flex-row gap-1.5`}>
                <Ionicons name="call-outline" size={16} color="#64748B" />
                <Text style={tw`text-xs font-black text-slate-500`}>Mobile Login</Text>
              </TouchableOpacity>
            ...
            <TouchableOpacity
              ...
              {loading ? (
                ...
                <>
                  <Text style={tw`text-base font-black text-white`}>Sign In with Email</Text>
